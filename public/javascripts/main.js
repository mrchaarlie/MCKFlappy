...
{
  name: "Ashish",
  picture: "/images/ashishh.jpg",
  icon: "/images/ashishbird.png",
  bw: "/images/ashish_bw.png",
  birdface: "/images/internbirdy_0002_ashish-bird.png",
...
{
  name: "Stephen Liu",
  picture: "/images/stephenjpg.jpg",
  icon: "/images/stephenbird.png",
  bw: "/images/stephen_bw.png",
  birdface: "/images/internbirdy_0001_stephen-bird.png",
...
},
{
  ...
  icon: "/images/charliebird.png",
  bw: "/images/charlie_bw.png",
  birdface: "/images/internbirdy_0000_charlie-bird.png",
...
},
{
  ...
  picture: "/images/rachel.jpg",
  icon: "/images/rachelbird.png",
  bw: "/images/rachel_bw.png",
  birdface: "/images/internbirdy_0003_rachel-bird.png",
...
//sounds
var volume = 30;
var soundJump = new buzz.sound("/images/sounds/sfx_wing.ogg");
var soundScore = new buzz.sound("/images/sounds/sfx_point.ogg");
var soundHit = new buzz.sound("/images/sounds/sfx_hit.ogg");
var soundDie = new buzz.sound("/images/sounds/sfx_die.ogg");
var soundSwoosh = new buzz.sound("/images/sounds/sfx_swooshing.ogg");
  ...
  $("#select" + i).click(function() {
    if (!interns[i].unlocked)
      ...
      if (currentavatar === i) {
        ...
        $("#player").css("background-image", "url('/images/bird.png')");
        currentavatar = null;
      }
...
function showAchievement(score)
{
   ...
   if (score == 2)
      $("#achievement").css("background-image", "url('/images/achievement_a.png')");
   else if (score == 4)
      $("#achievement").css("background-image", "url('/images/achievement_s.png')");
   else if (score == 6)
      $("#achievement").css("background-image", "url('/images/achievement_c.png')");
   else if (score == 8)
      $("#achievement").css("background-image", "url('/images/achievement_r.png')");
